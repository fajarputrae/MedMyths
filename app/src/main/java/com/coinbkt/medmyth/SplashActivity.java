...
public class SplashActivity extends AppCompatActivity {
    ...
    private void populatePacks(){
        ...
        int[] packsImg = new int[]{
                R.drawable.pack_food,
                R.drawable.pack_sport,
                R.drawable.pack_drink,
                R.drawable.pack_hiv,
                R.drawable.pack_gadget,
                R.drawable.pack_weather
        };

        daoSession.getPacksDao().deleteAll();
        packsList.clear();

        Packs packs = new Packs();
        packs.setIdPack(1);
        packs.setPackName("Food");
        packs.setPackStatus("Unlocked");
        packs.setPackImage(packsImg[0]);
        packs.setPackPoints(0);

        Packs packs1 = new Packs();
        packs1.setIdPack(2);
        packs1.setPackName("Sport");
        packs1.setPackStatus("Locked");
        packs1.setPackImage(packsImg[1]);
        packs1.setPackPoints(0);

        Packs packs2 = new Packs();
        packs2.setIdPack(3);
        packs2.setPackName("Drink");
        packs2.setPackStatus("Locked");
        packs2.setPackImage(packsImg[2]);
        packs2.setPackPoints(0);

        Packs packs3 = new Packs();
        packs3.setIdPack(4);
        packs3.setPackName("HIV");
        packs3.setPackStatus("Locked");
        packs3.setPackImage(packsImg[3]);
        packs3.setPackPoints(0);

        Packs packs4 = new Packs();
        packs4.setIdPack(5);
        packs4.setPackName("Gadget");
        packs4.setPackStatus("Locked");
        packs4.setPackImage(packsImg[4]);
        packs4.setPackPoints(0);

        Packs packs5 = new Packs();
        packs5.setIdPack(6);
        packs5.setPackName("Weather");
        packs5.setPackStatus("Locked");
        packs5.setPackImage(packsImg[5]);
        packs5.setPackPoints(0);

        daoSession.getPacksDao().insert(packs);
        daoSession.getPacksDao().insert(packs1);
        daoSession.getPacksDao().insert(packs2);
        daoSession.getPacksDao().insert(packs3);
        daoSession.getPacksDao().insert(packs4);
        daoSession.getPacksDao().insert(packs5);
